...
var app = (function () {
	 ...
	 * of values.
	 */
	var objectToString$6 = objectProto$a.toString;

	/** Built-in value references. */
	var propertyIsEnumerable$3 = objectProto$a.propertyIsEnumerable;
	...
	function arrayLikeKeys$2(value, inherited) {
	  // Safari 8.1 makes `arguments.callee` enumerable in strict mode.
	  // Safari 9 makes `arguments.length` enumerable in strict mode.
	  var result = (isArray$a(value) || isArguments$4(value))
	...
	function assignInDefaults(objValue, srcValue, key, object) {
	  if (objValue === undefined ||
	      (eq$2(objValue, objectProto$a[key]) && !hasOwnProperty$9.call(object, key))) {
	    return srcValue;
	  }
	  return objValue;
	}
	...
	function isArguments$4(value) {
	  // Safari 8.1 makes `arguments.callee` enumerable in strict mode.
	  return isArrayLikeObject$3(value) && hasOwnProperty$9.call(value, 'callee') &&
	    (!propertyIsEnumerable$3.call(value, 'callee') || objectToString$6.call(value) == argsTag$5);
	}
	...
	function isArrayLike$5(value) {
	  return value != null && isLength$8(value.length) && !isFunction$7(value);
	}
	...
	function isFunction$7(value) {
	  // The use of `Object#toString` avoids issues with the `typeof` operator
	  // in Safari 8-9 which returns 'object' for typed array and other constructors.
	  var tag = isObject$g(value) ? objectToString$6.call(value) : '';
	  return tag == funcTag$8 || tag == genTag$5;
	}
	 ...
	 * // => { 'a': 1, 'b': 2 }
	 */
	var defaults$1 = baseRest$1(function(args) {
	...
	function keysIn$2(object) {
	  return isArrayLike$5(object) ? arrayLikeKeys$2(object, true) : baseKeysIn$1(object);
	}
	...
	function selectAll(selector) {
	  return typeof selector === "string"
	      ...
	      : new Selection$1([selector == null ? [] : selector], root$3);
	}
	...
	var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(d3Selection);

	function getAtPath$1(object, path) {
	  var current = object;
	...
	var getAtPath_1 = getAtPath$1;

	var getAtPath = getAtPath_1;

	function accessor$5(prop, defaultValue) {
	  var property = 'id';
	...
	var accessor_1 = accessor$5;

	function GetPropertySafely$2(prop, defaultValue) {
	...
	var getPropertySafely = GetPropertySafely$2;

	var accessor$4 = accessor_1;
	...
	var renderDetailInnards$2 = renderDeedDetailInnards;
	...
	function compareDescForPolyptych$1(objectA, objectB) {
	...
	var comparators$3 = {
	  ...
	  compareDescForPolyptych: compareDescForPolyptych$1
	};

	var d3$8 = require$$0$1;
	var accessor$3 = accessor_1;
	var GetPropertySafely$1 = getPropertySafely;
	var renderDetailInnards$1 = renderDetailInnards$2;
	var comparators$2 = comparators$3;
...
`;
	...
	var idKey = accessor$3();
	var messageKey = accessor$3('message');

	var basicProjectListRoot = d3$8.select('#basic-project-list');

	var deedsKey$1 = GetPropertySafely$1('deeds', []);

	function RenderPlain$1({ user }) {
	  return renderPlain;

	  function renderPlain({ projectData }) {
	    projectData.sort(comparators$2.compareLastUpdatedDesc);
	    var projects = basicProjectListRoot
	      .selectAll('.project')
	      .data(projectData, accessor$3());
	    ...
	    var deeds = deedsRoot.selectAll('.deed').data(deedsKey$1, idKey);
	    // deeds.exit().remove();
	    var newDeeds = deeds
	      .enter()
	      .append('li')
	    ...
	    function callRenderInnards(project) {
	      renderDetailInnards$1({
	        parent: d3$8.select(this).select('.project-description'),
	        project,
	        user
	      });
	    }
	...
	function toggleDeedList() {
	  var deedsRoot = d3$8.select(findProjectParent(this)).select('.deeds-root');
	...
	var require$$2 = /*@__PURE__*/getAugmentedNamespace(d3Hierarchy);

	function countDeedsInProjects$2(projects) {
	...
	var countDeedsInProjects_1 = countDeedsInProjects$2;
	...
	function GetEvenIndexForString$1({ arrayLength }) {
	  var nextIndex = 0;
	...
	var getEvenIndexForString = GetEvenIndexForString$1;
	...
	var GetEvenIndexForString = getEvenIndexForString;

	var gardenColors = reorderByBucket(require$$1$1, 9);
	...
	function getGardenColorForProject$2(d) {
	  var id = d.id;
	  if (d.data) {
	    id = d.data.id;
	  }
	...
	var getGardenColorForProject_1 = getGardenColorForProject$2;

	var d3$7 = require$$0$1;
	var GetPropertySafely = getPropertySafely;
	var hierarchy = require$$2;
	var countDeedsInProjects$1 = countDeedsInProjects_1;
	var getGardenColorForProject$1 = getGardenColorForProject_1;
	...
	var labelLayer = d3$7.select('.field-label-layer');
	var canvasesContainer = d3$7.select('#canvases-container');
	var gardenContainer = d3$7.select('#garden-container');
	var gardenBoard = d3$7.select('#garden-board');
	var gardenTargetsBoard = d3$7.select('#garden-targets-board');
	var gardenBoardLabels = d3$7.select('#garden-board-labels');
	var gardenContext = gardenBoard.node().getContext('2d', { alpha: false });
	var gardenTargetsContext = gardenTargetsBoard
	  .node()
	  .getContext('2d', { alpha: false });

	var arrangementControls = d3$7.select('.arrangement-controls');
	var treemap;

	function RenderGarden$1({ onDeedClick }) {
	  return renderGarden;
	  ...
	  async function renderGarden({ projectData, expensiveRenderIsOK }) {
	    ...
	    if (!treemap || expensiveRenderIsOK) {
	      let neededArea =
	        countDeedsInProjects$1(projectData) * squarePixelAreaPerDeed;
	    ...
	    function onTargetBoardClick() {
	      var mouseX = d3$7.event.layerX;
	      var mouseY = d3$7.event.layerY;
	    ...
	    function deedColor(d) {
	      return getGardenColorForProject$1(d.parent);
	    }
	  }
	...
	var renderGarden = RenderGarden$1;

	var d3$6 = require$$0$1;

	function renderHeader$1({ currentUsername, activeView, changeView }) {
	  d3$6.select('#current-user-label-possessive').text(currentUsername + "'s");
	  d3$6.select('#current-user-label').text(currentUsername);
	  d3$6.selectAll('.view-button').on('click', onViewButtonClick);
	  d3$6.selectAll('.view-button').classed(
	    'active-view-button',
	    viewButtonIsActive
	  );
	...
	var renderHeader_1 = renderHeader$1;

	var d3$5 = require$$0$1;
	var renderDetailInnards = renderDetailInnards$2;

	function RenderDeedDetails$1({ user, detailsLayerSelector = '.details-layer' }) {
	  // Pre-rendering prep with static elements.
	  var detailsLayer = d3$5.select(detailsLayerSelector);
	...
	var renderDeedDetails = RenderDeedDetails$1;
	...
	function baseIndexOf$2(array, value, fromIndex) {
	  if (value !== value) {
	    return baseFindIndex$4(array, baseIsNaN$2, fromIndex);
	  }
	 ...
	 * of values.
	 */
	var objectToString$5 = objectProto$9.toString;
	 ...
	 */
	function baseCreate(proto) {
	  return isObject$f(proto) ? objectCreate(proto) : {};
	}
	...
	function baseIsNative$2(value) {
	  if (!isObject$f(value) || isMasked$2(value)) {
	    return false;
	  }
	  var pattern = (isFunction$6(value) || isHostObject$2(value)) ? reIsNative$4 : reIsHostCtor$4;
	...
	function createCtor(Ctor) {
	  return function() {
	    ...
	    return isObject$f(result) ? result : thisBinding;
	  };
	}
	 ...
	 */
	var setWrapToString = !defineProperty ? identity$3 : function(wrapper, reference, bitmask) {
	 ...
	 * // => [1, 2, 3]
	 */
	function curry$4(func, arity, guard) {
	  arity = guard ? undefined : arity;
	  var result = createWrap(func, CURRY_FLAG, undefined, undefined, undefined, undefined, undefined, arity);
	  result.placeholder = curry$4.placeholder;
	  return result;
	}
	...
	function isFunction$6(value) {
	  // The use of `Object#toString` avoids issues with the `typeof` operator
	  // in Safari 8-9 which returns 'object' for typed array and other constructors.
	  var tag = isObject$f(value) ? objectToString$5.call(value) : '';
	  return tag == funcTag$7 || tag == genTag$4;
	}
	...
	function isSymbol$1(value) {
	  return typeof value == 'symbol' ||
	    (isObjectLike$7(value) && objectToString$5.call(value) == symbolTag$1);
	}
	...
	function toNumber(value) {
	  ...
	  if (isObject$f(value)) {
	    ...
	    value = isObject$f(other) ? (other + '') : other;
	  }
	...
	var lodash_curry = curry$4;

	var comparators$1 = comparators$3;
	var curry$3 = lodash_curry;
	...
	function arrangeProjectDataByYear$1({ projectData, sortBy = 'startDate' }) {
	  var projectsByYear = {};
	  projectData.forEach(placeProject);

	  return Object.keys(projectsByYear)
	    .sort(comparators$1.compareDesc)
	    ...
	    function convertToMonthKit(month) {
	      return {
	        ...
	        projects: projectsByMonth[month].sort(
	          curry$3(comparators$1.compareDescWithSortKey)(sortBy)
	        )
	      };
	    }
	  }
	...
	var arrangeProjectDataByYear_1 = arrangeProjectDataByYear$1;
	 ...
	 * of values.
	 */
	var objToString$2 = objectProto$8.toString;

	/** Used to detect if a method is native. */
	var reIsNative$3 = RegExp('^' +
	  fnToString$1.call(hasOwnProperty$7).replace(/[\\^$.*+?()[\]{}|]/g, '\\$&')
	  .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'
	);
	 ...
	 * // => false
	 */
	var isArray$9 = nativeIsArray || function(value) {
	  return isObjectLike$6(value) && isLength$7(value.length) && objToString$2.call(value) == arrayTag$2;
	};
	...
	function isFunction$5(value) {
	  ...
	  return isObject$e(value) && objToString$2.call(value) == funcTag$6;
	}
	...
	function isNative$1(value) {
	  ...
	  if (isFunction$5(value)) {
	    return reIsNative$3.test(fnToString$1.call(value));
	  }
	  return isObjectLike$6(value) && reIsHostCtor$3.test(value);
	}

	var lodash_isarray = isArray$9;
	...
	function isTypedArray$1(value) {
	  return isObjectLike$5(value) &&
	    isLength$6(value.length) && !!typedArrayTags[objectToString$4.call(value)];
	}

	var lodash_istypedarray = isTypedArray$1;
	...
	var reIsNative$2 = RegExp('^' +
	  fnToString.call(hasOwnProperty$6).replace(/[\\^$.*+?()[\]{}|]/g, '\\$&')
	  .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'
	);
	...
	function isFunction$4(value) {
	  ...
	  // in older versions of Chrome and Safari which return 'function' for regexes
	  // and Safari 8 equivalents which return 'object' for typed array constructors.
	  return isObject$d(value) && objToString$1.call(value) == funcTag$4;
	}
	...
	function isNative(value) {
	  ...
	  if (isFunction$4(value)) {
	    return reIsNative$2.test(fnToString.call(value));
	  }
	  return isObjectLike$4(value) && reIsHostCtor$2.test(value);
	}

	var lodash__getnative = getNative$3;
	...
	/** Built-in value references. */
	var propertyIsEnumerable$2 = objectProto$5.propertyIsEnumerable;
	...
	function isArrayLike$4(value) {
	  return value != null && isLength$5(value.length) && !isFunction$3(value);
	}
	...
	function isFunction$3(value) {
	  // The use of `Object#toString` avoids issues with the `typeof` operator
	  // in Safari 8-9 which returns 'object' for typed array and other constructors.
	  var tag = isObject$c(value) ? objectToString$3.call(value) : '';
	...
	var lodash_isarguments = isArguments$3;
	...
	var getNative$2 = lodash__getnative,
	    isArguments$2 = lodash_isarguments,
	    isArray$8 = lodash_isarray;
	...
	/* Native method references for those with the same name as other `lodash` methods. */
	var nativeKeys$1 = getNative$2(Object, 'keys');
	 ...
	 */
	var getLength$2 = baseProperty$4('length');
	...
	function isArrayLike$3(value) {
	  return value != null && isLength$4(getLength$2(value));
	}
	...
	function isIndex$2(value, length) {
	  value = (typeof value == 'number' || reIsUint$2.test(value)) ? +value : -1;
	...
	function shimKeys(object) {
	  ...
	  var allowIndexes = !!length && isLength$4(length) &&
	  ...
	  while (++index < propsLength) {
	    var key = props[index];
	    if ((allowIndexes && isIndex$2(key, length)) || hasOwnProperty$4.call(object, key)) {
	      result.push(key);
	    }
	  }
	  return result;
	 ...
	 * // => ['0', '1']
	 */
	var keys$4 = !nativeKeys$1 ? shimKeys : function(object) {
	  var Ctor = object == null ? undefined : object.constructor;
	  if ((typeof Ctor == 'function' && Ctor.prototype === object) ||
	      (typeof object != 'function' && isArrayLike$3(object))) {
	    return shimKeys(object);
	  }
	  return isObject$b(object) ? nativeKeys$1(object) : [];
	};
	...
	function keysIn$1(object) {
	  ...
	  length = (length && isLength$4(length) &&
	    (isArray$8(object) || isArguments$2(object)) && length) || 0;
	  ...
	  for (var key in object) {
	    if (!(skipIndexes && isIndex$2(key, length)) &&
	        !(key == 'constructor' && (isProto || !hasOwnProperty$4.call(object, key)))) {
	      result.push(key);
	    }
	  }
	  return result;
	...
	var isArray$7 = lodash_isarray,
	    isTypedArray = lodash_istypedarray,
	    keys$3 = lodash_keys;
	 ...
	 * @returns {boolean} Returns `true` if the values are equivalent, else `false`.
	 */
	function baseIsEqual$2(value, other, customizer, isLoose, stackA, stackB) {
	  if (value === other) {
	    return true;
	  }
	  if (value == null || other == null || (!isObject$a(value) && !isObjectLike$2(other))) {
	    return value !== value && other !== other;
	  }
	  return baseIsEqualDeep(value, other, baseIsEqual$2, customizer, isLoose, stackA, stackB);
	}
	...
	function equalObjects(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
	  ...
	  while (index--) {
	    ...
	    if (!(isLoose ? key in other : hasOwnProperty$3.call(other, key))) {
	      return false;
	    }
	  }
	...
	var lodash__baseisequal = baseIsEqual$2;
	...
	var baseIsEqual$1 = lodash__baseisequal;
	 ...
	 */
	function baseIsMatch$2(object, matchData, customizer) {
	  ...
	  while (++index < length) {
	    ...
	    if (noCustomizer && data[2]) {
	      ...
	      if (!(result === undefined ? baseIsEqual$1(srcValue, objValue, customizer, true) : result)) {
	        return false;
	      }
	    }
	  }
	 ...
	 */
	function toObject$6(value) {
	  return isObject$9(value) ? value : Object(value);
	}
	...
	var lodash__baseismatch = baseIsMatch$2;
	 ...
	 * @returns {Object} Returns the object.
	 */
	function toObject$5(value) {
	  return isObject$8(value) ? value : Object(value);
	}
	 ...
	 */
	function pairs$2(object) {
	  object = toObject$5(object);
	...
	var baseIsMatch$1 = lodash__baseismatch,
	    pairs$1 = lodash_pairs;
	...
	function baseMatches$2(source) {
	  ...
	  if (matchData.length == 1 && matchData[0][2]) {
	    ...
	    return function(object) {
	      ...
	      return object[key] === value && (value !== undefined || (key in toObject$4(object)));
	    };
	  }
	  return function(object) {
	...
	var lodash__basematches = baseMatches$2;
	 ...
	 */
	function bindCallback$1(func, thisArg, argCount) {
	...
	var lodash__bindcallback = bindCallback$1;
	...
	var baseIsEqual = lodash__baseisequal,
	    bindCallback = lodash__bindcallback,
	    isArray$6 = lodash_isarray,
	    pairs = lodash_pairs;
	 ...
	 * @returns {Function} Returns the callback.
	 */
	function baseCallback$2(func, thisArg, argCount) {
	 ...
	 */
	function baseGet$2(object, path, pathKey) {
	  if (object == null) {
	    return;
	  }
	...
	function baseMatchesProperty(path, srcValue) {
	  var isArr = isArray$6(path),
	      isCommon = isKey$1(path) && isStrictComparable(srcValue),
	      pathKey = (path + '');
	  ...
	  return function(object) {
	    ...
	    if ((isArr || !isCommon) && !(key in object)) {
	      object = path.length == 1 ? object : baseGet$2(object, baseSlice(path, 0, -1));
	      if (object == null) {
	        return false;
	      }
	      key = last(path);
	...
	function basePropertyDeep$1(path) {
	  ...
	  path = toPath$2(path);
	  return function(object) {
	    return baseGet$2(object, path, pathKey);
	  };
	}
	...
	function isKey$1(value, object) {
	  var type = typeof value;
	  if ((type == 'string' && reIsPlainProp$1.test(value)) || type == 'number') {
	    return true;
	  }
	  if (isArray$6(value)) {
	    return false;
	  }
	  var result = !reIsDeepProp$1.test(value);
	...
	function toPath$2(value) {
	  ...
	  var result = [];
	  baseToString$1(value).replace(rePropName$1, function(match, number, quote, string) {
	...
	function property$1(path) {
	  return isKey$1(path) ? baseProperty$3(path) : basePropertyDeep$1(path);
	}

	var lodash__basecallback = baseCallback$2;
	...
	function baseForOwn(object, iteratee) {
	  return baseFor(object, iteratee, keys$1);
	}
	...
	var lodash__baseeach = baseEach$2;
	 ...
	 */
	function baseFind$1(collection, predicate, eachFunc, retKey) {
	  var result;
	...
	var lodash__basefind = baseFind$1;
	 ...
	 * @returns {number} Returns the index of the matched value, else `-1`.
	 */
	function baseFindIndex$3(array, predicate, fromRight) {
	  var length = array.length,
	      index = fromRight ? length : -1;
	...
	var lodash__basefindindex = baseFindIndex$3;
	...
	var baseCallback$1 = lodash__basecallback,
	    baseEach$1 = lodash__baseeach,
	    baseFind = lodash__basefind,
	    baseFindIndex$2 = lodash__basefindindex,
	    isArray$5 = lodash_isarray;
	...
	function createFind(eachFunc, fromRight) {
	  return function(collection, predicate, thisArg) {
	    predicate = baseCallback$1(predicate, thisArg, 3);
	    if (isArray$5(collection)) {
	      var index = baseFindIndex$2(collection, predicate, fromRight);
	 ...
	 * // => 'barney'
	 */
	var find$1 = createFind(baseEach$1);

	var lodash_find = find$1;
	...
	var baseMatches = lodash__basematches,
	    find = lodash_find;
	 ...
	 * // => 'fred'
	 */
	function findWhere$2(collection, source) {
	  return find(collection, baseMatches(source));
	}

	var lodash_findwhere = findWhere$2;
	 ...
	 * @returns {*} Returns the resolved value.
	 */
	function baseGet$1(object, path, pathKey) {
	  if (object == null) {
	    return;
	  }
	...
	function toObject$1(value) {
	  return isObject$4(value) ? value : Object(value);
	}
	...
	var lodash__arraymap = arrayMap$3;
	...
	var arrayMap$2 = lodash__arraymap,
	    baseCallback = lodash__basecallback,
	    baseEach = lodash__baseeach,
	    isArray$3 = lodash_isarray;
	 ...
	 * @returns {*} Returns the "length" value.
	 */
	var getLength = baseProperty$1('length');
	 ...
	 * // => ['barney', 'fred']
	 */
	function map$1(collection, iteratee, thisArg) {
	  var func = isArray$3(collection) ? arrayMap$2 : baseMap;
	  iteratee = baseCallback(iteratee, thisArg, 3);
	  return func(collection, iteratee);
	}

	var lodash_map = map$1;
	...
	var baseGet = lodash__baseget,
	    toPath = lodash__topath,
	    isArray$2 = lodash_isarray,
	    map = lodash_map;
	...
	function toObject(value) {
	  return isObject$3(value) ? value : Object(value);
	}
	 ...
	 */
	function pluck$1(collection, path) {
	...
	var lodash_pluck = pluck$1;

	var findWhere$1 = lodash_findwhere;
	var pluck = lodash_pluck;
	var curry$2 = lodash_curry;
	var comparators = comparators$3;

	function mergeYearKits$1(yearKitsForSorts) {
	  ...
	  function mergeKitsForYears(year) {
	    ...
	    return {
	      ...
	      monthKits: months
	        ...
	        .map(curry$2(mergeKitsForMonths)(year))
	    };
	  }
	  ...
	  function mergeKitsForMonths(year, month) {
	    ...
	    for (var sort in yearKitsForSorts) {
	      ...
	      let yearKit = findWhere$1(yearKits, { year });
	      if (!yearKit) {
	        continue;
	      }
	      let monthKit = findWhere$1(yearKit.monthKits, { month });
	      if (monthKit) {
	...
	var mergeYearKits_1 = mergeYearKits$1;

	var d3$4 = require$$0$1;
	var accessor$2 = accessor_1;
	var arrangeProjectDataByYear = arrangeProjectDataByYear_1;
	var mergeYearKits = mergeYearKits_1;
	var findWhere = lodash_findwhere;

	var yearContainer = d3$4.select('#year-container');
	var yearsRoot = d3$4.select('#years-root');
	...
	function RenderYearView$1({ onDeedClick }) {
	  return renderYearView;

	  function renderYearView({ projectData }) {
	    d3$4.selectAll('.view-root:not(#year-container)').classed('hidden', true);
	    ...
	    yearsToUpdate.select('.year-title').text(accessor$2('year'));
	    ...
	    var months = yearsToUpdate
	      .select('.month-root')
	      .selectAll('.month')
	      .data(accessor$2('monthKits'), accessor$2('month'));
	    ...
	    monthsToUpdate.select('.month-title').text(accessor$2('name'));

	    var monthSortSections = monthsToUpdate
	      .select('.month-sort-section-root')
	      .selectAll('.month-sort-section')
	      .data(accessor$2('projectsWithSort'), accessor$2('sort'));
	    ...
	    var projects = monthSortSectionsToUpdate
	      ...
	      .selectAll('.project')
	      .data(accessor$2('projects'), accessor$2()); // Need to provide accessor so that things get properly removed/added.
	    ...
	    projectsToUpdate.select('.project-name').text(accessor$2('name'));
	...
	var renderYearView = RenderYearView$1;

	function Crown$1(createOpts) {
	  var crownClass;
	...
	var require$$6 = /*@__PURE__*/getAugmentedNamespace(src$2);

	var d3$3 = require$$0$1;
	var accessor$1 = accessor_1;
	var { compareDescForPolyptych } = comparators$3;
	var curry$1 = lodash_curry;
	var Crown = csscrown;
	var getGardenColorForProject = getGardenColorForProject_1;
	var { hsl } = require$$6;
	...
	var polyptychContainer = d3$3.select('#polyptych-container');
	var polyptychRoot = d3$3.select('#polyptych-root');

	function RenderPolyptych$1() {
	  return renderPolyptych;

	  function renderPolyptych({ projectData }) {
	    projectData.sort(compareDescForPolyptych);

	    d3$3.selectAll('.view-root:not(#polyptych-container)').classed(
	      'hidden',
	      true
	    );
	    polyptychContainer.classed('hidden', false);

	    var tychs = polyptychRoot.selectAll('.tych').data(projectData, accessor$1());
	    tychs.exit().remove();
	    var newTychs = tychs
	      .enter()
	      .append('div')
	    ...
	    projectWindows.attr('src', accessor$1('profileImage'));
	    currentTychs.select('.description').html(accessor$1('description'));

	    var linksRoots = currentTychs.selectAll('.links-root');

	    var linkItems = linksRoots.selectAll('li').data(getLinks, accessor$1('0'));
	    ...
	    currentTychs
	      ...
	      .text(curry$1(getReadableDate)('startDate'));
	    currentTychs
	      .select('.shipped-date .value')
	      .text(curry$1(getReadableDate)('shippedDate'));
	    currentTychs
	      .select('.last-updated-date .value')
	      .text(curry$1(getReadableDate)('lastActiveDate'));
	    currentTychs
	      .select('.project-age .value')
	      .text(accessor$1('activitySpanInDays'));
	    currentTychs
	      .select('.activity-count .value')
	      .text(accessor$1({ path: 'activities/length' }));
	...
	function focusOnTych(project) {
	  ...
	  if (d3$3.event.target.tagName === 'A') {
	    return;
	  }

	  var currentlySelectedTych = d3$3.select('.selected-tych');
	...
	var renderPolyptych = RenderPolyptych$1;
	...
	function addDeedToProject$1(onError, collectedProjectsByName, deed) {
	...
	var addDeedToProject_1 = addDeedToProject$1;
	...
	var noThrowJsonParse = noThrowJSONParse;

	var parse$1 = noThrowJsonParse;

	var lineWithEndRegex = /(.*\n)/;

	function getUserCommitsFromServer$1(
	...
	var getUserCommitsFromServer_1 = getUserCommitsFromServer$1;
	...
	var handleErrorWeb = handleError$2;

	var d3$2 = require$$0$1;

	function switchViewRoot$1(viewId) {
	  var containerId = viewId + '-container';
	  d3$2.selectAll('.view-root:not(#' + containerId + ')').classed('hidden', true);
	  d3$2.select('#' + containerId).classed('hidden', false);
	}

	var switchViewRoot_1 = switchViewRoot$1;

	const dayInMS = 24 * 60 * 60 * 1000;

	function decorateProject$1(project, nowInEpochTime = Date.now(), runSort = true) {
	...
	var decorateProject_1 = decorateProject$1;
	...
	var lodash_compact = compact$1;

	var compact = lodash_compact;
	...
	function renderLoadProgress$1({ deedCount, projectCount, active }) {
	...
	var renderLoadProgress_1 = renderLoadProgress$1;

	function filterProjects$1({ projectData, filterCriteria, filterMode = 'some' }) {
	  // Filter
	...
	var filterProjects_1 = filterProjects$1;
	...
	*/
	...
	var defaultCriteria = criteria$1;

	function getCriteriaForNames$1(names, criteria = defaultCriteria) {
	...
	var getCriteriaForNames_1 = getCriteriaForNames$1;
	...
	var Timer = require$$0.timer;
	var easeCubicIn = require$$1.easeCubicIn;
	...
	var easeThrottle = EaseThrottle$1;
	...
	var d3$1 = require$$0$1;
	var curry = lodash_curry;
	var accessor = accessor_1;
	var groupBy = lodash_groupby.exports;
	var listParser$1 = routeListParser;
	...
	function renderArrangementControls$1({
	  containerSelector,
	  ...
	  var selectedCriteriaNameArray = listParser$1.parse(selectedCriteriaNames);
	  var container = d3$1.select(containerSelector);
	  ...
	  function renderCriteria(
	    ...
	    d3$1.select(someFilterOption).on('click', onSomeFilterClick);
	    d3$1.select(everyFilterOption).on('click', onEveryFilterClick);
	...
	var renderArrangementControls_1 = renderArrangementControls$1;
	...
	function renderArrangementMetaControls$1({
	...
	var renderArrangementMetaControls_1 = renderArrangementMetaControls$1;

	var request = basicrequest.exports;
	var RenderPlain = renderPlain;
	var RenderGarden = renderGarden;
	var renderHeader = renderHeader_1;
	var RenderDeedDetails = renderDeedDetails;
	var RenderYearView = renderYearView;
	var RenderPolyptych = renderPolyptych;
	var values = lodash_values;
	var omit = lodash_omit;
	var addDeedToProject = addDeedToProject_1;
	var getUserCommitsFromServer = getUserCommitsFromServer_1;
	var handleError$1 = handleErrorWeb;
	var countDeedsInProjects = countDeedsInProjects_1;
	var switchViewRoot = switchViewRoot_1;
	var decorateProject = decorateProject_1;
	var uniq = lodash_uniq;
	var listParser = routeListParser;
	var renderLoadProgress = renderLoadProgress_1;
	var filterProjects = filterProjects_1;
	var getCriteriaForNames = getCriteriaForNames_1;
	var EaseThrottle = easeThrottle;
	var renderArrangementControls = renderArrangementControls_1;
	var renderArrangementMetaControls = renderArrangementMetaControls_1;
	...
	function ProjectsFlow$1({
	  ...
	  function collectDeed(commit, source) {
	    ...
	    if (deed.projectName in collectedProjectsByName) {
	      addDeedToProject(handleError$1, collectedProjectsByName, deed);
	    } else {
	...
	var projectsFlow$1 = ProjectsFlow$1;

	var name = "observatory";
	var version$1 = "1.0.2";
	var description = "Observes the work you've done; kind of an anti-planner.";
	var main = "index.js";
	var scripts = {
		test: "make test"
	};
	var repository = {
		type: "git",
		url: "git@github.com:jimkang/observatory.git"
	};
	var keywords = [
	];
	var author = "Jim Kang";
	var license = "MIT";
	var bugs = {
		url: "https://github.com/jimkang/observatory/issues"
	};
	var homepage = "https://github.com/jimkang/observatory";
	var devDependencies = {
	...
	var dependencies = {
		accessor: "^3.0.0",
		"add-deed-to-project": "^1.0.0",
		"basic-browser-request": "^9.0.1",
		csscrown: "^1.0.0",
		"d3-axis": "^1.0.8",
		"d3-color": "^1.3.0",
		"d3-ease": "^1.0.5",
	...
	var ProjectsFlow = projectsFlow$1;
	var handleError = handleErrorWeb;
	var { version } = require$$3;
